...
import java.util.LinkedList;//imports the Queue class
public class Tree {
	
	private int height;
	private Node root;
	/**
	 * Creates a constructor for a tree that will be generated
	 */
	public Tree(){
			setRoot(new Node(1));
	}//end tree
	...
	/**
	 * Method to return the root of a subtree
	 * @return the root
	 */
	public Node getRoot() {
		return root;
	...
	/**
	 * Generates a tree of a binary tree with a height specified by the user
	 * @param height the height of the tree that the user wants to generate
